...
module.exports = (client) => {
    ...
    client.errNormal = async function ({
        ...
        embed.addFields( 
            { name: "<:helix_error:1099600656270110741> • ┆**Error comment**", value: `> \`\`\`${error}\`\`\` `},
        )
    ...
    client.errUsage = async function ({
        ...
        embed.addFields(
            { name: "<:message1:1099268715859673099> • ┆**Required arguments**", value: `> \`\`\`${usage}\`\`\``},    
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errMissingPerms = async function ({
        ...
        embed.addFields(
            { name: "<a:Yellow_key:1099271261730918521> • ┆**Required Permission**", value: `> \`\`\`${perms}\`\`\``},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errWait = async function ({
        ...
        embed.addFields(
            { name: "<:Alarm_Clock:1099019789663481958> • ┆**Try again on**", value: `> **<t:${time}:f>**`},
        )
        embed.setColor(client.config.colors.error)
