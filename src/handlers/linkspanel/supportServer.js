    ...
    client.on(Discord.Events.InteractionCreate, async (interaction) => {
        ...
        if (interaction.customId == "Bot-linkspanel") {
            if (interaction.values == "support-linkspanel") {
                ...
                client.embed({
                    title: `<:Support:1099042098432462990>・Support Server`,
                    desc: `**> Join our dedicated support server to receive personalized assistance, engage in lively discussions, and stay updated with the latest features and announcements!**`,
