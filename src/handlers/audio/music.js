        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId == "Bot-musicprev") {
                ...
                let row = new Discord.ActionRowBuilder()
                    .addComponents(
                        new Discord.ButtonBuilder()
                            .setEmoji(client.emotes.normal.music.previous)
                            .setCustomId("Bot-musicprev")
                            .setStyle(Discord.ButtonStyle.Primary),

                        new Discord.ButtonBuilder()
                            .setEmoji(client.emotes.normal.music.play)
                            .setCustomId("Bot-musicpause")
                            .setStyle(Discord.ButtonStyle.Primary),

                        new Discord.ButtonBuilder()
                            .setEmoji(client.emotes.normal.music.stop)
                            .setCustomId("Bot-musicstop")
                            .setStyle(Discord.ButtonStyle.Primary),

                        new Discord.ButtonBuilder()
                            .setEmoji(client.emotes.normal.music.next)
                            .setCustomId("Bot-musicnext")
                            .setStyle(Discord.ButtonStyle.Primary),
                    );
