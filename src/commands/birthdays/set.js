...
module.exports = async (client, interaction, args) => {
    ...
    if (!day || day > 31) return client.errNormal({ 
        error: " <:Cross:1093511027943014490> Wrong day format !",
        type: 'editreply'
    }, interaction);

    if (!month || month > 12) return client.errNormal({
        error: "<:Cross:1093511027943014490> Wrong month format !",
        type: 'editreply'
    }, interaction);
    ...
    client.succNormal({ 
        text: `<:check:1099309087675654235> Birthday has been set successfully !!`,
        fields: [
            {
