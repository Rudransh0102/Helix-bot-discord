...
module.exports = async (client, interaction, args) => {
    ...
    if (type == "add") {
        ...
        let embedLogs = new Discord.EmbedBuilder()
            ...
            .addFields(
                { name: "<:user:1099054255656148993>┆Added By", value: `${interaction.user} (${interaction.user.tag})`, inline: true },
        ...
        let embedLogs = new Discord.EmbedBuilder()
            ...
            .addFields(
                { name: "<:user:1099054255656148993>┆Removed By", value: `${interaction.user} (${interaction.user.tag})`, inline: true },
                { name: "🔢┆Amount", value: `${amount}`, inline: true },
            )
            .setColor(client.config.colors.normal)
            .setTimestamp();
