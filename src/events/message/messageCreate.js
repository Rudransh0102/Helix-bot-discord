...
module.exports = async (client, message) => {
  ...
  if (message.channel.type === Discord.ChannelType.DM) {
    let embedLogs = new Discord.EmbedBuilder()
      .setTitle(`<:message1:1099268715859673099>・New DM message!`)
      .setDescription(`Bot has received a new DM message!`)
      .addFields(
        { name: "<:user:1099054255656148993>┆Send By", value: `${message.author} (${message.author.tag})`, inline: true },
        { name: `<:message1:1099268715859673099>┆Message`, value: `${message.content || "None"}`, inline: true },
      )
    ...
    if (message.attachments.size > 0)
      embedLogs.addFields(
        { name: `<:uo_paper:1099220386253639741>┆Attachments`, value: `${message.attachments.first()?.url}`, inline: false },
      )
    return dmlog.send({
      username: "Bot DM",
      embeds: [embedLogs],
      ...
      .embed(
        {
          ...
          fields: [
            {
              name: "<:invite:1099209986497859634>┆Invite me",
              value: `**> Invite Bot in your own server! [Click here](${client.config.discord.botInvite})**`,
            },
            {
              name: "<:bot_question_mark:1099014442831859774>┇I don't see any slash commands",
            ...
            {
              name: "<:bot_question_mark:1099014442831859774>┆Need support?",
              value: `**> For questions you can join our [support server](${client.config.discord.serverInvite})!**`,
            },
            {
              name: "<:bug:1099039556747149414>┆Found a bug?",
