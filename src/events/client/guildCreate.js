...
module.exports = async (client, guild) => {
    ...
    try {
        const promises = [
            client.shard.Eval(client => client.guilds.cache.size),
        ...
        client.embed({
            ...
            {
                name: "<:Support:1099042098432462990>┆I need help what now?",
                value: `**> You can DM <@769467035419279391> for support or joining the [[Support server]](${client.config.discord.serverInvite})**`,
                inline: false,
            },
            {
                name: `${client.emotes.normal.tv} ┆What are the commands?`,
                value: '**> See that list of commands by doing \`/help\`**',
                inline: false,
            },
            {
                name: "<:invite:1099209986497859634>┆Invite the bot!",
